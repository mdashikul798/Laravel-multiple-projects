...
<head>
	...
	<!-- Slick -->
	<link type="text/css" rel="stylesheet" href="{{ asset('assets/webSite') }}/css/slick.css" />
	<link type="text/css" rel="stylesheet" href="{{ asset('assets/webSite') }}/css/slick-theme.css" />

	<!-- nouislider -->
	<link type="text/css" rel="stylesheet" href="{{ asset('assets/webSite') }}/css/nouislider.min.css" />
									...
									<div class="shopping-cart-list">
										<div class="product product-widget">
											<div class="product-thumb">
												<img src="{{ asset('assets/webSite') }}/img/thumb-product01.jpg" alt="">
											</div>
