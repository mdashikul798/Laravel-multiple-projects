...
<head>
    ...
    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('admin') }}/css/morris{{ asset('admin') }}/js/morris.css">
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-table icon-wrap"></i> <span class="mini-click-non">Category</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Manage category" href="#"><span class="mini-sub-pro">Manage-category</span></a></li>
                                <li><a title="Add category" href="{{ route('add.category') }}"><span class="mini-sub-pro">Add-category</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Manager product" href="{{ route('manage.product') }}"><span class="mini-sub-pro">Manage-product</span></a></li>
                                <li><a title="Add Product" href="{{ route('add.product') }}"><span class="mini-sub-pro">Add-product</span></a></li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Dashboard One</h2>
												<p>Welcome to PaymentSystem <span class="bread-ntd">Admin Panel</span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright © 2020 <a href="#">PaymentSystem</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
