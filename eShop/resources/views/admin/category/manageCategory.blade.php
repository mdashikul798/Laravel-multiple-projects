                    ...
                    <div class="product-status-wrap">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input {{ $row->status ==1 ? 'checked':''}}  data-size="mini" id="categoryStatus" data-id="{{ $row->id}}" type="checkbox" data-toggle="toggle" data-on="Active" data-off="Inactive">
                                </td>
                                <td>
                                    ...
                                    <a id="delete" href="{{ route('delete-category', $row->id) }}">
