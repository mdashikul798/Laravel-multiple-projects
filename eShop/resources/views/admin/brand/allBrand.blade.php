                    ...
                    <div class="product-status-wrap">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>{{ $row->brad_name }}</td>
                                <td>
									<input {{ $row->brand_status ==1 ? 'checked':''}}  data-size="mini" id="brandStatus" data-id="{{ $row->id}}" type="checkbox" data-toggle="toggle" data-on="Active" data-off="Inactive">
                                </td>
                                <td>
                                    ...
                                    <a id="delete" href="{{ route('delete-brand', $row->id) }}">
