                                        ...
                                        <div class="form-group-inner">
                                            ...
                                            <select class="form-control" id="cat_id" name="category_id">
                                                ...
                                                @foreach($category as $category)
                                                    <option value="{{ $category->id }}" {{ $subId->cat_id == $category->id ? 'selected':''}} >{{ $category->category_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group-inner">
                                            <label>Sub Category Name</label>
                                            <input type="text" name="subCategory_name" value="{{ $subId['name'] }}" class="form-control" placeholder="Enter Sub Category Name" />
                                        </div>
